...
def main():
    ...
    input_depth_dir = os.path.expanduser(
        #'/home/nvidia/Kitti/depth/depth_selection/val_selection_cropped/velodyne_raw')
         '/home/nvidia/photo')
    data_split = 'val'
    ...
    # Fast fill with Gaussian blur @90Hz
    #fill_type = 'fast'
    #extrapolate = False
    #blur_type = 'bilateral'

    # Fast Fill with bilateral blur, no extrapolation @87Hz
    # fill_type = 'fast'
    # extrapolate = False
    # blur_type = 'bilateral'
    ...
    for i in range(num_images):
        ...
        projected_depths = np.float32(depth_image) #保持原始深度
        ...
        if save_depth_maps:
 		...
 		#输出原始深度
                depth_image = (final_depths).astype(np.uint16)
