...
cv::Vec3b  image_color[720][1280];  //全局变量都能访问，图像中修改，点云中获取
...
public:
  ros::Subscriber subCloud = n.subscribe<sensor_msgs::PointCloud2>("/rslidar_points", 1, &pcl_fusion::getcloud, this); //接收velodyne点云数据，进入回调函数getcloud()
  ...
  void getcloud(const sensor_msgs::PointCloud2ConstPtr& laserCloudMsg){
    ...
    for (int i = 0; i <  raw_pcl_ptr->points.size(); i++)
    {
      ...
      if ( pt.x >=0 &&pt.x <  1280 && pt.y>=0 && pt.y<720 && Y.at<double>(2,0)>0) //&& raw_pcl_ptr->points[i].x>0去掉图像后方的点云
      {
        PointXYZRGBIR  p;
        p.x=raw_pcl_ptr->points[i].x;
        p.y=raw_pcl_ptr->points[i].y;
    ...
    fusion_msg.header.frame_id = "pcl_fusion";//帧id改成和velodyne一样的
...
void loadCalibrationData(void )
{
  ...
  RT.at<double>(0,0) = -5.86235479e-02; RT.at<double>(0,1) = -9.97841572e-01; RT.at<double>(0,2) = 2.95958441e-02; RT.at<double>(0,3) =0.0359704;
  RT.at<double>(1,0) = -3.38164575e-04; RT.at<double>(1,1) = -2.96268414e-02; RT.at<double>(1,2) = -9.99564858e-01; RT.at<double>(1,3) = -0.244404;
  RT.at<double>(2,0) = 9.98284121e-01; RT.at<double>(2,1) = -5.86080086e-02; RT.at<double>(2,2) = -1.39939017e-03; RT.at<double>(2,3) = -0.402803;
  RT.at<double>(3,0) = 0.0; RT.at<double>(3,1) = 0.0; RT.at<double>(3,2) = 0.0; RT.at<double>(3,3) = 1.0;

  //相机的内参矩阵
  P_rect_00.at<double>(0,0) =701.4300000; P_rect_00.at<double>(0,1) = 0.000000e+00; P_rect_00.at<double>(0,2) = 609.04000; P_rect_00.at<double>(0,3) = 0.000000e+00;  
  P_rect_00.at<double>(1,0) = 0.000000e+00; P_rect_00.at<double>(1,1) = 701.4300000; P_rect_00.at<double>(1,2) = 349.5755000; P_rect_00.at<double>(1,3) = 0.000000e+00;  
